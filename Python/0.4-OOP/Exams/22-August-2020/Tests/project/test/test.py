...
class StudentReportCardTests(TestCase):
    ...
    def test_init_student_name_cannot_be_empty_string_raises(self):
    ...
    def test_init_school_year_must_be_between_1_and_12_raises(self):
        with self.assertRaises(ValueError) as ex:
    ...
    def test_add_grade_subject_not_in_grades_by_subjects(self):
        self.assertDictEqual({}, self.student_card.grades_by_subject)
    ...
    def test_report_average_grade_for_all_subjects_success(self):
