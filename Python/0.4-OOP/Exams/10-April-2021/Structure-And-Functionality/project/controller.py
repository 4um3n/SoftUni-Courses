...
class Controller:
    ...
    def add_aquarium(self, aquarium_type: str, aquarium_name: str):
        if aquarium_type not in Controller.__VALID_AQUARIUM_TYPES:
            return f"Invalid aquarium type."

        aquarium = Controller.__VALID_AQUARIUM_TYPES[aquarium_type](aquarium_name)
        self.aquariums.append(aquarium)
        return f"Successfully added {aquarium_type}."

    def add_decoration(self, decoration_type: str):
        if decoration_type not in Controller.__VALID_DECORATIONS_TYPES:
            return f"Invalid decoration type."

        decoration = Controller.__VALID_DECORATIONS_TYPES[decoration_type]()
    ...
    def add_fish(self, aquarium_name: str, fish_type: str, fish_name: str, fish_species: str, price: float):
        if fish_type not in Controller.__VALID_FISH_TYPES:
            return f"There isn't a fish of type {fish_type}."

        fish = Controller.__VALID_FISH_TYPES[fish_type](fish_name, fish_species, price)
        aquarium = self.find_aquarium_by_name(aquarium_name)
